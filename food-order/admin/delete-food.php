...
if($res==TRUE)
   {
    ...
    $_SESSION['delete']= "<div class='success'> food deleted successfully. </div>"; //it will display the message in main-content(manage-admin.php)
   ...
   else
   {
    ...
    header("location:".SITEURL.'admin/manage-food.php'); //it will redirect in add-admin page
