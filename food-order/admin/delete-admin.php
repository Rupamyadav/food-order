...
if($res==TRUE)
   {
    ...
    $_SESSION['delete']= "<div class='success'> admin deleted successfully. </div>"; //it will display the message in main-content(manage-admin.php)
   ...
   else
   {
    ...
    header("location:".SITEURL.'admin/manage-admin.php'); //it will redirect in add-admin page
